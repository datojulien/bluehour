...
Bluehour is accepted as `1.0.0-rc.2` when the automated gate passes and the manual stable-release gate remains clearly documented as incomplete.
...
- [x] Daily Review derives persistent checklist items from uncategorised splits, due plans, uncertain imports, deferred extra income, sync issues, and projected shortfalls.
...
- [x] Subscriptions show monthly equivalents, annual totals, renewal/cancellation alerts, metadata edits, and safe archive/cancel handling.
- [x] IndexedDB schema is v5, demo fixture version is v5, and optional Google Sheet schema is v4.
