...
const STARTER_CATEGORY_DEFINITIONS: Array<Pick<Category, "id" | "name" | "group" | "nature" | "reservationMode" | "sortOrder">> = [
  ...
  { id: "cat-dining", name: "Dining Out", group: "discretionary", nature: "discretionary", reservationMode: "none", sortOrder: 210 },
  { id: "cat-entertainment", name: "Entertainment", group: "discretionary", nature: "discretionary", reservationMode: "none", sortOrder: 220 },
  { id: "cat-shopping", name: "Shopping", group: "discretionary", nature: "discretionary", reservationMode: "none", sortOrder: 230 },
  { id: "cat-travel", name: "Travel", group: "discretionary", nature: "discretionary", reservationMode: "none", sortOrder: 240 },
